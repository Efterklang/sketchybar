...
music_title=(
  ...
  padding_right=0
  width=0
  label.font="$MUSIC_FONT:Bold:15.0"
  label.color=$TEXT
...
music_artist=(
  ...
  padding_right=0
  width=0
  label.font="$MUSIC_FONT:Regular:13.0"
...
music_state=(
  icon.drawing=on
  icon.font="$MUSIC_FONT:10.0"
  icon.width=$ICON_WIDTH
  icon="00:00"
  label.drawing=on
  label.font="$MUSIC_FONT:10.0"
  ...
  slider.highlight_color=$LAVENDER
  slider.percentage=0
