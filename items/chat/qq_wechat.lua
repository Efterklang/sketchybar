...
wechat:subscribe({ "forced", "routine" }, function() get_app_status("com.tencent.xinWeChat", wechat) end)

qq:subscribe({ "forced", "routine" }, function() get_app_status("com.tencent.qq", qq) end)
