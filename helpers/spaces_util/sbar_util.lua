-- Use Greek alphabet
local greek_uppercase = { "Α", "B", "Γ", "Δ", "E", "Z", "H", "Θ", "I", "K",
    "Λ", "M", "N", "Ξ", "O", "Π", "P", "Σ", "T", "Y", "Φ", "X", "Ψ", "Ω"
}

local greek_lowercase = { "α", "β", "γ", "δ", "ε", "ζ", "η", "θ", "ι", "κ",
    "λ", "μ", "ν", "ξ", "ο", "π", "ρ", "σ", "τ", "υ",
    "φ", "χ", "ψ", "ω"
}
...
function space_api.highlight_focused_space(sbar_item, is_selected)
    sbar_item.space:set({
        ...
        background = { border_color = is_selected and COLORS.mantle or COLORS.surface1 }
    })
    sbar_item.bracket:set({
